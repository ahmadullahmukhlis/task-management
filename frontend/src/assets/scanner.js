...
;(function () {
    ...
    var deployJava = (function () {
        ...
        var o = {
            ...
            u =
                (o.object.concat(o.core, o.i18n, o.events),
                o.applet.concat(o.core)),
            h = {
                debug: null,
                version: '20120801',
                ...
                versionCheck: function (t) {
                    ...
                    var u =
                        'Invalid versionPattern passed to versionCheck: ' + t
                ...
                setInstallerType: function (e) {
                    return (
                        (this.installType = e),
                        this.isPluginInstalled()
                            ? this.getPlugin().setInstallerType(e)
                            : !1
                    )
                },
                ...
                getBrowser: function () {
                    if (null == this.browserName) {
                        ...
                        e(
                            '[getBrowser()] navigator.userAgent.toLowerCase() -> ' +
                                t,
                        ),
                ...
                testForMSVM: function () {
                    ...
                    if ('undefined' != typeof oClientCaps) {
                        var t = oClientCaps.getComponentVersion(
                            e,
                            'ComponentID',
                        )
                    ...
                    if (null != navigator.mimeTypes) {
                        for (var t = 0; t < navigator.mimeTypes.length; t++) {
                            if (
                                ...
                                modelsToAppendToBodyFromDeployJava.push(n),
                                    (e = !0)
                            }
                        }
                        if (!e) {
                            for (
                                var t = 0;
                                t < navigator.mimeTypes.length;
                                t++
                            ) {
                                if (
                                    navigator.mimeTypes[t].type ==
                                        this.oldMimeType &&
                                    navigator.mimeTypes[t].enabledPlugin
                                ) {
                                    ;({
                                    ...
                                    modelsToAppendToBodyFromDeployJava.push(
                                        this.oldMimeType,
                                    )
                                }
                            }
    ...
    g.g = function () {
        return 'object' === typeof this.a
            ? Math.floor(this.a.XResolution)
            : void 0
    }
    g.o = function () {
    ...
    function n(a, b) {
        ...
        !c &&
            ...
            (c =
                a in window.scannerjs_config
                    ? window.scannerjs_config[a]
                    : void 0)
    ...
    oa = n(
        'form_field_name_for_img_urls',
        'com_asprise_scannerjs_images_urls[]',
    )
    D = !1
    pa = n('eager_init', !0)
    E = null
    ...
    function U(a, b, c, d, f, e, k, m, v, aa) {
        ...
        if (!V() && !q)
            return (
                p && P()
                    ? null != E &&
                      1e4 < new Date().getTime() - E.getTime() &&
                      xa(!0)
                    : xa(!0),
                !1
            )
        ...
        if ('function' !== typeof a)
            return (
                W(
                    'asprise_scanner_js_call_function requires a valid callbackFunc',
                ),
                !1
            )
                        ...
                        function (a, b) {
                            try {
                                w.send(
                                    d +
                                        ':' +
                                        JSON.stringify({ success: a, data: b }),
                                )
                            } catch (x) {
    ...
    function X(a, b, c, d, f, e, k) {
        null != f &&
            1 != f &&
            W('resultCount should be null or 1, actual: ' + f)
        if (k)
        ...
        if (a || b) {
            if (!b) {
                ...
                if (null == c)
                    return (
                        W(
                            'please do not execute displaySetupDialog in <header>!',
                        ),
                        !1
                    )
                c.appendChild(Y(b))
    ...
    function ca(a, b) {
        if (!R())
            return (
                W('base64ToBlob() is not supported in legacy browsers.'), null
            )
    ...
    function ta() {
        if (0 != modelsToAppendToBodyFromDeployJava.length) {
            ...
            if (null == a) W('Unexcepted error - unable to get body')
                ...
                for (
                    var b = 0;
                    b < modelsToAppendToBodyFromDeployJava.length;
                    b++
                )
        ...
        if (b instanceof Array && 0 != b.length) {
            ...
            if (null == e) W("Form doesn't exist: " + a)
                ...
                for (d = 0; d < b.length; d++)
                    (f = b[d]),
                        f.b
                            ? a.append(ma, ca(f.src, f.mimeType))
                            : a.append(oa, f.src)

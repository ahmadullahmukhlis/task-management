    ...
    public function handle(object $event): void
    {
        ...
        switch ($service) {
            case 'adjustment': case 'product_adjustment':
                $this->adjustmentAccounting($warehouse_id, $currency_id, $product_id, (float) $amount, $particular, $module, true);
                break;
            case 'adjustment_rm':
                $this->adjustmentAccounting($warehouse_id, $currency_id, $product_id, (float) $amount, $particular, $module, false);
                break;
            case 'sale':
                $this->sale($warehouse_id, $currency_id, $product_id, (float) $amount, $particular, $module, $customer_id);
                break;
            case 'first_capital':
            ...
            case 'capital_remove':
                ...
                break;
            case 'purchase':
                $this->purchase($warehouse_id, $currency_id, $product_id, (float) $amount, $particular, $module, $customer_id, $amount);
                break;
        }
    }
